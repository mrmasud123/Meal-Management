                ...
                <div class="mill-contents">
                    <div class="total-mill mt-2 mb-3 d-flex flex-column">
                        ...
                        <h5><span class="badge bg-info">Mill Rate : 
                            <?php 
                                $DB->select("bazar_tbl","SUM(amount) as total_bazar_amount",null,"MONTHNAME(amt_paid_date) = '$mill_month'");
                    ...
                    <?php  
                        /*  */
                        $DB->select("mill_tbl","*",null,"MONTHNAME(mill_date) = '$mill_month'");
                    ...
                    <div class="mill-table">
                        <table class="table table-hover table-info table-borderd table-stripped">
                            ...
                            <tbody>
                                    <?php
                                        $DB->select("mill_tbl","DISTINCT(mill_date)",null,"MONTHNAME(mill_date) = '$mill_month'","mill_date ASC");
                                        ...
                                        <tr class="text-center">
                                            <td ><?php echo $date['mill_date']; ?></td>
                                                ...
                                                <?php
                                                    ...
                                                    $DB->sql("SELECT * from mill_tbl where mill_date='$unique_mill_date' AND MONTHNAME(mill_date)='$mill_month' ORDER BY member_name ASC");
                                    ...
                                    <tr class="text-center bg-success">
                                        ...
                                        $total_mill_arr=[];
                                            foreach($total_members as $tm){
                                                $DB->select("mill_tbl","SUM(mill_count) as p_w_mill,member_name",null,"member_name='$tm' AND MONTHNAME(mill_date) ='$mill_month'");
                                            ...
                                            for($x=0; $x<count($total_members); $x++){
                                                ...
                                                $DB->select("mill_tbl","*",null,"member_name='$m_name' AND MONTHNAME(mill_date) = '$mill_month'");
                                                if(count($DB->getResult())>0){
                                                    $DB->select("mill_tbl","SUM(mill_count) as total_mill",null,"member_name='$m_name' AND MONTHNAME(mill_date) = '$mill_month'");
                    ...
                    <?php  
                        /*  */
                        $DB->select("bazar_tbl","*",null,"MONTHNAME(amt_paid_date) = '$mill_month'");
                        if(count($DB->getResult())>0){
                    ?>
                    <div class="money w-100 mt-5 ">
                        <div class="deopsit-money">
                            <h1 class="mb-3 header__style">Bazar Amount</h1>
                            <a href="generate-bazar.php?month=<?php echo $mill_month ?>" class="btn btn-sm btn-success mb-3">Generate Bazar PDF</a>
                        <table class="table table-info table-borderd table-hover table-stripped">
                            ...
                            <tbody>
                                <?php
                                        $DB->select("bazar_tbl","DISTINCT(amt_paid_date)",null,"MONTHNAME(amt_paid_date) = '$mill_month'","amt_paid_date ASC");
                                ...
                                <tr class="text-center">
                                    ...
                                    <?php
                                            ...
                                            $DB->sql("SELECT * from bazar_tbl where amt_paid_date='$unique_bazar_date' AND MONTHNAME(amt_paid_date)='$mill_month' ORDER BY member_name ASC");
                                ...
                                <?php
                                    ...
                                    <tr class="text-center bg-success">
                                        ...
                                        $person_wise_bazar_arr=[];
                                            foreach($total_members as $tm){
                                                $DB->select("bazar_tbl","SUM(amount) as p_w_amount,member_name",null,"member_name='$tm' AND MONTHNAME(amt_paid_date) = '$mill_month'");
